	...
	export default {
		...
		methods: {
			...
			drag_hmove(event){
					...
					console.log(this.hekaobj.style)
			},
			change_anmition(e){
			...
			getinfo(id) {
				...
				// this.hekaobj = {
				// 	card_id: "5",
				// 	content: "八月十五月儿圆，幸福快乐人团圆，天天好梦圆又圆，吃个月饼香又甜，好运连连常相伴，欢乐人人笑开颜，恭祝您中秋节，快乐美满又团圆!",
				// 	id: "3",
				// 	insert_time: "1631546073",
				// 	music: "https://yxy-1306997902.cos.ap-nanjing.myqcloud.com/xiaochengxu-images/music_5.mp3",
				// 	pics: "https://yxy-1306997902.cos.ap-nanjing.myqcloud.com/4444.jpg",
				// 	status: "1",
				// 	// style: "{"animation":"downshow","position":["25","300"],"width":"300px","lineHeight":2,"marginLeft":"-150px","fontSize":"40rpx"}",
				// 	style: {
				// 		position: ["36", "300"],
				// 		animation: 'downshow',
				// 	},
