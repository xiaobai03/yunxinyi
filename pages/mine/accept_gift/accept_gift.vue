<template>
	<view class="content">
		<view class="search_box">
			<view class="search">
				<input class="search_input" placeholder="请输入您要找的送礼人" v-model="value" type="text"/>
				...
				<view class="card_body" >
					...
					<view class="item_name">
						<view class="box" style="width: 280upx;">
							<view class="group">
								<view class="cell">送礼人</view>
								<view class="cell text">{{item.from_name}}</view>
							</view>
						</view>
						<view class="box" style="margin-left: 20upx;">
							<text class="date_text">日期：{{item.time}}</text>
						</view>
					</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			gotoDetails(e){
				uni.navigateTo({
					url:'/pages/mine/accept_gift/details/details?id=' + e
				})
			}
		}
	}
